...
import lol.roxxane.roxxys_survival_core.screens.RscSmithingScreen;
...
public class Rsc {
	...
	public Rsc(FMLJavaModLoadingContext context) {
		...
		REGISTRATE.addRawLang("jei.category.roxxys_survival_core.smithing", "Smithing");
		REGISTRATE.addRawLang("container.roxxys_survival_core.smithing_table", "Smithing Table");
		...
		MenuScreens.register(RscMenuTypes.SMITHING, RscSmithingScreen::new);
